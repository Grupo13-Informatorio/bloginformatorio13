...
from .views import  ArticuloBusquedaView, ArticuloListView, ArticuloResumidoView, AutorListView, BorrarArticuloView, BorrarCategoriaView, CategoriaListView, ArticuloView,  CrearArticulo, CrearCategoria, EditarArticulo
...
urlpatterns = [
    ...
    path('autor/<int:pk>/', AutorListView.as_view(), name='autor'),
